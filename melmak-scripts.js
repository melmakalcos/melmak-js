...
(function () {
  ...
  (function () {
    ...
    s.appendChild(document.createTextNode(
      ...
      '[class*="product-offer"]' +
      '{ z-index:50 !important; position:relative; }'
    ));
  ...
  function atar() {
    ...
    for (var i = 0; i < cs.length; i++) (function (c) {
      ...
      lu.style.cssText = 'position:absolute;inset:0;pointer-events:none;z-index:2;' +
        ...
        'rgba(255,255,255,.55),transparent 55%);opacity:0;transition:opacity .15s;' +
      ...
      c.addEventListener('mousemove', function (e) {
        ...
        var ry = detalle ? 12 : 40;   /* feed: hasta 40 grados ¡FUERTE! */
        var rx = detalle ? 9  : 30;   /* feed: hasta 30 */
        var sc = detalle ? 1.03 : 1.10;
        var pe = detalle ? 800 : 240; /* perspectiva corta = giro profundo */
