...
(function () {
    ...
    style.textContent = [
        ...
        '#melmak-bienvenida .mw-banda__palabra span{color:#ffffff;}',
        '#melmak-bienvenida .mw-banda__palabra span.c-amarillo{color:#ffee26;}',
        ...
        '  font-size:clamp(16px,2.5vw,18px);font-weight:400;line-height:1.6;',
        '  color:#353535;opacity:.95;margin:0 auto;text-align:left;',
        '  white-space:pre-line;min-height:4.8em;',
        ...
        '  #melmak-bienvenida .mw-caja{max-width:80%;}',
        '}',
