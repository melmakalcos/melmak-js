...
(function () {
    ...
    style.textContent = [
        ...
        '.melk-catalogo .melk-note { position: relative; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 26px 20px 24px; min-height: 244px; -webkit-box-sizing: border-box; box-sizing: border-box; background-color: var(--background-color); border: 0; transition: transform .35s cubic-bezier(.2,.8,.2,1), box-shadow .35s ease, filter .35s ease; }',
        ...
        '.melk-catalogo .melk-note { width: 100%; padding: 36px 48px 36px; min-height: 400px; border: 3px solid #353535; }',
        '.melk-catalogo .melk-note--food { border-radius: 0 0 0 42px; }',
        '.melk-catalogo .melk-note--beauty { border-radius: 0 0 42px 0; }',
        '.melk-catalogo .melk-note--food, .melk-catalogo .melk-note--beauty { background-image: url("https://d22fxaf9t8d39k.cloudfront.net/d01fd4d9104d589a5a8564963f4fb4c4a270b5ec9ed1a0686cae8e706e4ed68120700.gif"); background-size: cover; background-position: center; }',
