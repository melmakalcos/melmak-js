...
(function () {
    ...
    style.textContent = [
        ...
        '.melk-catalogo { padding: 20px 16px 150px; background-color: #ffffff; font-family: \'Rubik\', system-ui, sans-serif; color: #353535; }',
        ...
        '.melk-catalogo .melk-list { list-style: none; margin: 20px 0 0; padding: 0; display: flex; flex-direction: column; gap: 110px; }',
        ...
        '.melk-catalogo .melk-item__body { display: flex; flex-direction: column; gap: 110px; }',
        ...
        '.melk-catalogo .melk-item__body { display: flex; align-items: stretch; justify-content: flex-start; gap: 0; }',
